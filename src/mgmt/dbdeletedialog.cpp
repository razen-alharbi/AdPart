...
//---------------------------------------------------------------------------
DBDeleteDialog::DBDeleteDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::DBDeleteDialog)
{
    deleteContent = false;
    ui->setupUi(this);
...
DBDeleteDialog::~DBDeleteDialog()
{
    delete ui;
}

void DBDeleteDialog::updateState(){
    deleteContent = ui->delContent->isChecked();
}

void DBDeleteDialog::accept(){
    this->done(1);
}
